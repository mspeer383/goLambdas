...
//Request Holds data from SNS / Cloudwatch Alarm
type Request struct {
	Records []struct {
		SNS struct {
...
//SNSMessage struct to represent JSON from SNS
...
//SlackMessage struct to represent JSON post content for Slack
type SlackMessage struct {
	Text        string       `json:"text"`
	Attachments []Attachment `json:"attachments"`
}

//Attachment is structure for the JSON to attach to a Slack Message
